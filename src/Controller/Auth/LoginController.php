...
class LoginController extends AbstractController
{
    ...
    public function register(Request $request, EntityManagerInterface $em, UserPasswordHasherInterface $passwordHasher, UserRepository $userRepository, MailerInterface $mailer, string $appUrl = "https://app.mytodos.icewize.fr/"): Response
    {
        ...
        $rules = [
            ...
            'username' => [new Required(), new Type('string')],
        ...
        /** @var string */
        $usernameField = $payload->get('username');
        /** @var string */
